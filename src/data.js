export const personalInfo = {
    ...
    tagline: "Building secure and aesthetic digital experiences.",
...
export const experience = [
    {
        ...
        duration: "Present",
        description: [
            "Designed and implemented an interactive Floorplan visualization using SVG coordinate mapping to render multi-floor plant layouts with asset overlays.",
            "Developed core backend services in Node.js (RESTful APIs) for domain models and architected the Service Form workflow.",
            "Designed and normalized the PostgreSQL relational schema, implemented indexes and migrations, and integrated with ORM layers."
        ]
    },
    {
...
export const skills = {
    technical: ["C", "Java", "Python", "JavaScript", "React Native", "Data Structures", "Algorithms", "AI", "Data Visualization", "SQL"],
    tools: ["Git/GitHub", "Power BI", "Linux", "Wireshark", "Burpsuite", "Hashcat", "Nmap", "Nikto", "Termux", "MongoDB", "PostgreSQL"],
    productivity: ["Microsoft Excel", "Microsoft Word", "Microsoft PowerPoint", "Canva", "DaVinci Resolve", "ExcaliDraw", "Notion", "Cursor"],
    frameworks: ["Node.js", "Express.js", "Pandas", "Scikit-Learn", "Numpy", "Matplotlib", "React", "Tensorflow(Basics)"]
};

export const certifications = [
    "Winner, Codeflix 6.0 (1st place out of 200 participants)",
    "Winner, Schema Showdown (1st place out of 70 participants)",
